-- Scratch 5 Query 2 Wind Ranges whisker plot (see additional procedures at bottom of file)
--Query 2: Wind speed deviation for whisker plot
...
CREATE TABLE "Query: Wind Speed Deviations" AS(
  ...
  public.brisbane_clean_data."wind_speed_(m/s)" AS "Brisbane Wind Speed Km/h",
  public.gladstone_clean_data."wind_speed_(m/s)" AS "Gladstone Wind Speed Km/h",
  3.6*public.brisbane_clean_data."wind_speed_(m/s)" AS "Brisbane Wind Std Deviation Km/h", --Scaling factor: 1 m/s = 3.6 km/h
  3.6*public.gladstone_clean_data."wind_speed_(m/s)" AS "Gladstone Wind Std Deviation Km/h"

...
SELECT datetime_id, "wind_direction_(degN)", "wind_speed_(m/s)",
  ...
  "rainfall_(mm)", "barometric_pressure_(hPa)" , "PM10_(ug/m3)", "PM2.5_(ug/m3)",
  "nitrogen_oxide_(ppm)", "nitrogen_dioxide_(ppm)", "nitrogen_oxides_(ppm)"
  , "carbon_monoxide_(ppm)"
